        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('fornecedor.novo')}}" type="button" class="btn btn-block btn-primary btn-sm left"><i class="fa fa-solid fa-plus"></i> Novo</a>
                </div>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($fornecedores as $c)
                        <tr>
                            ...
                            <td>{{$c->telefone01}}</td>
                            <td>
                                <a href="{{route('fornecedor.editar',$c->id)}}" class="btn btn-block btn-warning btn-xs">
