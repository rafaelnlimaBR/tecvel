                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  class="form-control dinheiro" id="valor" name="valor" placeholder="Valor" value="{{isset($terceirizado)?$terceirizado->valor:''}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="servico" >{{isset($terceirizado)?$terceirizado->servico:''}}</textarea>
